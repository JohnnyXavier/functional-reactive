...
@Service
@Log4j2
public class CommentsByPostByIdExternalDataServiceStrategy extends ExternalDataServiceStrategy
{
    @Override
    ...
    public Mono<PipelineMessage> get( final PipelineMessage message )
    {
        ...
        final String apiCallPath = String.format( getConfig().getVendor().getPathCommentsByPostId(), postId );
